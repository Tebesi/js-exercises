...
house.currentOwner = newCurrentOwner;// - assign the value of the variable 'newCurrentOwner' as the value to the house's "currentOwner"
house.previousOwners.splice(1,1,"Stephen B");// - from the list of previous owners, replace only "John A." with "Stephen B."
house.isForSale = false;// - give the house a new property called 'isForSale' with the value 'false'
