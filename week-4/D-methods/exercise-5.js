...
var coffeeMachine = {
    ...
    getCoffee: function(coffeeName) {
       var coffeePrice = this.prices[coffeeName];
      if(this.insertedAmount >= coffeePrice) {
          return `Please take your ${coffeeName}`;
      }else{
          return `Sorry you don't have money for a ${coffeeName}`;
      }
    }
};
